...
# 下面是用户的问题，请用上面的人设回答："""
    ...
    def load_config(self):
        ...
        try:
            ...
            self.enable = True
            self.conversation_id = "1650947611770882"
            self.section_id = "1650947611771138"
            self.cookie = ""
            self.admin_list = []
            ...
            self.bot_wxid = ""
            self.daily_limit = 20
            self.commands = ["/豆包", "/db", "/doubao", "豆包", "doubao"]
            
            # 引用功能默认设置
            self.enable_quote = True
            self.private_quote = True
            self.group_quote = True
            self.quote_require_at = True
